...
import (
	...
	proto "github.com/Totarae/GophKeeper/internal/pkg/proto_gen"
	"net"
	"testing"
	"time"
...
type mockDataServiceClient struct {
	mergeFunc      func(ctx context.Context, in *proto.MergeRequest, opts ...grpc.CallOption) (*proto.DataResponse, error)
	getUpdatesFunc func(ctx context.Context, in *proto.GetUpdatesRequest, opts ...grpc.CallOption) (*proto.DataListResponse, error)
}

func (m *mockDataServiceClient) Merge(ctx context.Context, in *proto.MergeRequest, opts ...grpc.CallOption) (*proto.DataResponse, error) {
	return m.mergeFunc(ctx, in, opts...)
}
...
func TestClient_Upsert(t *testing.T) {
	...
	response, err := client.Merge(context.Background(), userData)
	assert.NoError(t, err)
